...
const About = () => {
  ...
  const currentTechArray = activeTab === 'programming' ? programmingTech : designTech;
  const displayedTech = currentTechArray.slice(currentTechIndex, currentTechIndex + 6);

  // Auto-rotate tech stack - slower rotation
  useEffect(() => {
                    ...
                    <button
                      ...
                      className={`flex-1 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${
                        activeTab === 'programming'
                          ? `${theme.textPrimary} bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border ${theme.border}`
